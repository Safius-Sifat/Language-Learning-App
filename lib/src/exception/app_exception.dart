import 'package:language_learning_app/src/utils/string_extensions.dart';
...
class UserNotFoundException extends AppException {
  UserNotFoundException()
      : super(
            'user-not-found',
            'It seems like you are signed out. Please sign or register to continue'
                .hardcoded);
}
...
class AlreadyMemberException extends AppException {
  AlreadyMemberException()
      : super('already-member',
            'You have already joined this classroom'.hardcoded);
}

class CreatorClassroomException extends AppException {
  CreatorClassroomException()
      : super('you-created-classroom',
            'You have created this classroom'.hardcoded);
}
